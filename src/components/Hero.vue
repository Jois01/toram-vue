<template>
  ...
  >
    ...
    <!-- Gambar Profile -->
    <div class="image flex justify-center items-center sm:w-80 w-56 mx-auto">
      <div class="profile">
        <img :src="profile.image" :alt="profile.alt" class="block rounded-t-lg" />
        <div
          class="text-lg font-bold sm:w-80 w-56 bg-gray-800 dark:bg-gray-100 text-white dark:text-gray-900 text-center py-2 rounded-b-md"
        >
          {{ profile.name }}
        </div>
      </div>
